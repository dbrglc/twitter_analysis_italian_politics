...
rm(i, max, min, sentimenti_globali, sentimenti_standard, sentimenti, vocabolariMadda, itastopwords, tweet)
```

La prima tabella rappresenta i 5 politici con cui queste 5 politici presi in esame hanno dei rapporti d'animosità.
La seconda tabella riporta i 5 politici per i quali hanno mediamente speso buone parole.
